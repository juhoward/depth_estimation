...
class CardDetector(object):
    ...
    def show_match(self, scene_corners, img_scene, cnt):
        ...
        cv.line(img_matches, (int(scene_corners[0,0,0] + self.img_obj.shape[1]), int(scene_corners[0,0,1])),\
            (int(scene_corners[1,0,0] + self.img_obj.shape[1]), int(scene_corners[1,0,1])), (0,255,0), 4)
        cv.line(img_matches, (int(scene_corners[1,0,0] + self.img_obj.shape[1]), int(scene_corners[1,0,1])),\
            (int(scene_corners[2,0,0] + self.img_obj.shape[1]), int(scene_corners[2,0,1])), (0,255,0), 4)
        cv.line(img_matches, (int(scene_corners[2,0,0] + self.img_obj.shape[1]), int(scene_corners[2,0,1])),\
            (int(scene_corners[3,0,0] + self.img_obj.shape[1]), int(scene_corners[3,0,1])), (0,255,0), 4)
